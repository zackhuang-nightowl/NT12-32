...
#define ONVIF_ERR_BASE          -0x1000

/***************************************************************************************/
typedef enum 
{
    ONVIF_OK = 0,
    ONVIF_ERR_Genenal = ONVIF_ERR_BASE, 
    ONVIF_ERR_Action,                                   // Action Failed
    ONVIF_ERR_OutofMemory,                              // Out of Memory
    ONVIF_ERR_CriticalError,                            // Critical Error
    ONVIF_ERR_InvalidIPv4Address,                       // The suggested IPv4 address is invalid
    ONVIF_ERR_InvalidIPv6Address,                       // The suggested IPv6 address is invalid
    ONVIF_ERR_InvalidDnsName,                           // The suggested NTP server name is invalid
    ONVIF_ERR_ServiceNotSupported,                      // The supplied network service is not supported
    ONVIF_ERR_PortAlreadyInUse,                         // The selected port is already in use
    ONVIF_ERR_InvalidGatewayAddress,                    // The supplied gateway address was invalid
    ONVIF_ERR_InvalidHostname,                          // The requested hostname cannot be accepted by the device
    ONVIF_ERR_MissingAttribute,                         // Missing the attruibute
    ONVIF_ERR_InvalidDateTime,                          // An invalid date or time was specified
    ONVIF_ERR_InvalidTimeZone,                          // An invalid time zone was specified
    ONVIF_ERR_ProfileExists,                            // Profile token already exists
    ONVIF_ERR_MaxNVTProfiles,                           // The maximum number of supported profiles supported by the device has been reached.
    ONVIF_ERR_NoProfile,                                // The requested profile token does not exist
    ONVIF_ERR_DeletionOfFixedProfile,                   // The fixed Profile cannot be deleted
    ONVIF_ERR_NoConfig,                                 // The requested entry does not exist
    ONVIF_ERR_NoPTZProfile,                             // The requested profile token does not reference a PTZ configuration
    ONVIF_ERR_NoHomePosition,                           // No home position has been defined for this Profile
    ONVIF_ERR_NoToken,                                  // The requested entry token does not exist
    ONVIF_ERR_PresetExist,                              // The requested name already exist for another preset
    ONVIF_ERR_TooManyPresets,                           // Maximum number of Presets reached
    ONVIF_ERR_MovingPTZ,                                // Preset cannot be set while PTZ unit is moving
    ONVIF_ERR_NoEntity,                                 // No such entity on the device
    ONVIF_ERR_InvalidNetworkInterface,                  // The supplied network interface token does not exists
    ONVIF_ERR_InvalidMtuValue,                          // The MTU value is invalid
    ONVIF_ERR_ConfigModify,                             // The configuration parameters are not possible to set
    ONVIF_ERR_ConfigurationConflict,                    // The new settings conflict with other uses of the configuration
    ONVIF_ERR_InvalidPosition,                          // The requested position is out of bounds
    ONVIF_ERR_TooManyScopes,                            // The requested scope list exceeds the supported number of scopes
    ONVIF_ERR_FixedScope,                               // Trying to Remove fixed scope parameter, command rejected
    ONVIF_ERR_NoScope,                                  // Trying to Remove scope which does not exist
    ONVIF_ERR_ScopeOverwrite,                           // Trying overwriting permanent device scope setting
    ONVIF_ERR_ResourceUnknownFault,                     // The pull point reference is invalid
    ONVIF_ERR_NoSource,                                 // The requested VideoSource does not exist
    ONVIF_ERR_CannotOverwriteHome,                      // The home position is fixed and cannot be overwritten
    ONVIF_ERR_SettingsInvalid,                          // The requested settings are incorrect
    ONVIF_ERR_NoImagingForSource,                       // The requested VideoSource does not support imaging settings
    ONVIF_ERR_UsernameClash,                            // Username already exists
    ONVIF_ERR_PasswordTooLong,                          // The password is too long
    ONVIF_ERR_UsernameTooLong,                          // The username is too long
    ONVIF_ERR_Password,                                 // Too weak password
    ONVIF_ERR_TooManyUsers,                             // Maximum number of supported users exceeded
    ONVIF_ERR_AnonymousNotAllowed,                      // User level anonymous is not allowed
    ONVIF_ERR_UsernameTooShort,                         // The username is too short
    ONVIF_ERR_UsernameMissing,                          // Username not recognized
    ONVIF_ERR_FixedUser,                                // Fixed user
    ONVIF_ERR_MaxOSDs,                                  // The maximum number of supported OSDs by the specific VideoSourceConfiguration has been reached
    ONVIF_ERR_InvalidStreamSetup,                       // Specification of StreamType or Transport part in is not supported

    ONVIF_ERR_BadConfiguration,                         // The RecordConfiguration is invalid
    ONVIF_ERR_MaxRecordings,                            // The device cannot create a new recording because it already has the maximum number of recordings that it supports
    ONVIF_ERR_NoRecording,                              // The RecordingToken does not reference an existing recording
    ONVIF_ERR_CannotDelete,                             // This specific recording cannot be deleted
    ONVIF_ERR_MaxTracks,                                // The new track cannot be created because the maximum number of tracks that the device supports for this recording has been reached
    ONVIF_ERR_NoTrack,                                  // The TrackToken does not reference an existing track of the recording
    ONVIF_ERR_MaxRecordingJobs,                         // The maximum number of recording jobs that the device can handle has been reached
    ONVIF_ERR_MaxReceivers,                             // The maximum supported number of receivers has been reached
    ONVIF_ERR_NoRecordingJob,                           // The JobToken does not reference an existing job
    ONVIF_ERR_BadMode,                                  // The Mode is invalid
    ONVIF_ERR_InvalidToken,                             // Invalid entity token
    
    ONVIF_ERR_InvalidRule,                              // The suggested rule configuration is not valid on the device
    ONVIF_ERR_RuleAlreadyExistent,                      // A rule with the same name already exists in the configuration
    ONVIF_ERR_TooManyRules,                             // There is not enough space in the device to add the rules to the configuration
    ONVIF_ERR_RuleNotExistent,                          // The rule name or names do not exist
    ONVIF_ERR_NameAlreadyExistent,                      // The same analytics module name exists already in the configuration
    ONVIF_ERR_TooManyModules,                           // There are not enough resources in the device to add the analytics modules to the configuration
    ONVIF_ERR_InvalidModule,                            // The suggested module configuration is not valid on the device
    ONVIF_ERR_NameNotExistent,                          // The same analytics module name exists already in the configuration

    ONVIF_ERR_InvalidFilterFault,                       // Invalid event filter 
    ONVIF_ERR_InvalidTopicExpressionFault,              // Invalid topic expression
    ONVIF_ERR_TopicNotSupportedFault,                   // Topic not support
    ONVIF_ERR_InvalidMessageContentExpressionFault,     // Invalid message content expression

    ONVIF_ERR_InvalidStartReference,                    // StartReference is invalid or has timed out. Client needs to start fetching from the beginning
    ONVIF_ERR_TooManyItems,                             // Too many items were requested, see MaxLimit capability
    ONVIF_ERR_NotFound,                                 // AccessPoint is not found 
    ONVIF_ERR_NotSupported,                             // The operation is not supported
    ONVIF_ERR_Failure,                                  // Failed to go to Accessed state and unlock the door

    ONVIF_ERR_NoVideoOutput,                            // The requested VideoOutput indicated with VideoOutputToken does not exist
    ONVIF_ERR_NoAudioOutput,                            // The requested AudioOutput indicated with AudioOutputToken does not exist
    ONVIF_ERR_RelayToken,                               // Unknown relay token reference
    ONVIF_ERR_ModeError,                                // Monostable delay time not valid
    ONVIF_ERR_InvalidSerialPort,                        // The supplied serial port token does not exist
    ONVIF_ERR_DataLengthOver,                           // Number of available bytes exceeded
    ONVIF_ERR_DelimiterNotSupported,                    // Sequence of character (delimiter) is not supported

    ONVIF_ERR_InvalidDot11,                             // IEEE 802.11 configuration is not supported
    ONVIF_ERR_NotDot11,                                 // The interface is not an IEEE 802.11 interface
    ONVIF_ERR_NotConnectedDot11,                        // IEEE 802.11 network is not connected
    ONVIF_ERR_NotScanAvailable,                         // ScanAvailableDot11Networks is not supported

    ONVIF_ERR_NotRemoteUser,                            // Remote User handling is not supported

    ONVIF_ERR_NoVideoSource,                            // The requested video source does not exist
    ONVIF_ERR_NoVideoSourceMode,                        // The requested video source mode does not exist

    ONVIF_ERR_NoThermalForSource,                       // The requested VideoSource does not support thermal settings
    ONVIF_ERR_NoRadiometryForSource,                    // The requested VideoSource does not support radiometry settings
    ONVIF_ERR_InvalidConfiguration,                     // The requested configuration is incorrect

    ONVIF_ERR_MaxAccessProfilesPerCredential,           // There are too many access profiles per credential
    ONVIF_ERR_CredentialValiditySupported,              // Credential validity is not supported by device
    ONVIF_ERR_CredentialAccessProfileValiditySupported, // Credential access profile validity is not supported by the device
    ONVIF_ERR_SupportedIdentifierType,                  // Specified identifier type is not supported by device
    ONVIF_ERR_DuplicatedIdentifierType,                 // The same identifier type was used more than once
    ONVIF_ERR_InvalidFormatType,                        // Specified identifier format type is not supported by the device
    ONVIF_ERR_InvalidIdentifierValue,                   // Specified identifier value is not as per FormatType definition
    ONVIF_ERR_DuplicatedIdentifierValue,                // The same combination of identifier type, format and value was used more than once
    ONVIF_ERR_ReferenceNotFound,                        // A referred entity token is not found
    ONVIF_ERR_ExemptFromAuthenticationSupported,        // Exempt from authentication is not supported by the device
    ONVIF_ERR_MaxCredentials,                           // There is not enough space to create a new credential
    ONVIF_ERR_ReferenceInUse,                           // Failed to delete, token is in use
    ONVIF_ERR_MinIdentifiersPerCredential,              // At least one credential identifier is required
    ONVIF_ERR_InvalidArgs,

    ONVIF_ERR_MaxAccessProfiles,                        // There is not enough space to add new AccessProfile, see the MaxAccessProfiles capability
    ONVIF_ERR_MaxAccessPoliciesPerAccessProfile,        // There are too many AccessPolicies in anAccessProfile, see MaxAccessPoliciesPerAccessProfile capability
    ONVIF_ERR_MultipleSchedulesPerAccessPointSupported, // Multiple AccessPoints are not supported for the same schedule, see MultipleSchedulesPerAccessPointSupported capability
    ONVIF_ERR_InvalidArgVal,                            // Invalid parameters value

    ONVIF_ERR_MaxSchedules,                             // There is not enough space to add new schedule, see MaxSchedules capability
    ONVIF_ERR_MaxSpecialDaysSchedules,                  // There are too many SpecialDaysSchedule entities referred in this schedule, see MaxSpecialDaysSchedules capability
    ONVIF_ERR_MaxTimePeriodsPerDay,                     // There are too many time periods in a day schedule, see MaxTimePeriodsPerDay capability
    ONVIF_ERR_MaxSpecialDayGroups,                      // There is not enough space to add new SpecialDayGroup items, see the MaxSpecialDayGroups capabilit
    ONVIF_ERR_MaxDaysInSpecialDayGroup,                 // There are too many special days in a SpecialDayGroup, see MaxDaysInSpecialDayGroup capability

    ONVIF_ERR_UnknownToken,                             // The receiver indicated by ReceiverToken does not exist
    ONVIF_ERR_CannotDeleteReceiver,                     // It is not possible to delete the specified receiver, for example because it is currently in use    

    ONVIF_ERR_MaxMasks,                                 // The maximum number of supported masks by the specific VideoSourceConfiguration has been reached

    ONVIF_ERR_IPFilterListIsFull,                       // It is not possible to add more IP filters since the IP filter list is full. 
    ONVIF_ERR_NoIPv4Address,                            // The IPv4 address to be removed does not exist
    ONVIF_ERR_NoIPv6Address,                            // The IPv6 address to be removed does not exist

    ONVIF_ERR_NoProvisioning,                           // Provisioning is not supported for this operation on the given video source
    ONVIF_ERR_NoAutoMode,                               // Cannot set position automatically

    ONVIF_ERR_TooManyPresetTours,                       // There is not enough space in the device to create the new preset tour to the profile
    ONVIF_ERR_InvalidPresetTour,                        // The requested PresetTour includes invalid parameter(s)
    ONVIF_ERR_SpaceNotSupported,                        // A space is referenced in an argument which is not supported by the PTZ Node
    ONVIF_ERR_ActivationFailed,                         // The requested preset tour cannot be activated while PTZ unit is moving or another preset tour is now activated

    ONVIF_ERR_MaxDoors,                                 // There is not enough space to add the new door, see the MaxDoors capability
    ONVIF_ERR_ClientSuppliedTokenSupported,             // The device does not support that the client supplies the token

    ONVIF_ERR_GeoMoveNotSupported,                      // The device does not support geo move
    ONVIF_ERR_UnreachablePosition,                      // The requested translation is out of bounds
    ONVIF_ERR_TimeoutNotSupported,                      // The specified timeout argument is not within the supported timeout range
    ONVIF_ERR_GeoLocationUnknown,                       // The unit is not able to perform GeoMove because its geolocation is not configured or available
    ONVIF_ERR_InvalidSpeed,                             // The requested speed is out of bounds
    ONVIF_ERR_InvalidTranslation,                       // The requested translation is out of bounds
    ONVIF_ERR_InvalidVelocity,                          // The requested speed is out of bounds
    ONVIF_ERR_NoStatus,                                 // Status is unavailable in the requested Media Profile

    ONVIF_ERR_AccesslogUnavailable,                     // There is no access log information available
    ONVIF_ERR_SystemlogUnavailable,                     // There is no system log information available
    ONVIF_ERR_NtpServerUndefined,                       // Cannot switch DateTimeType to NTP because no NTP server is defined
    ONVIF_ERR_InvalidInterfaceSpeed,                    // The suggested speed is not supported
    ONVIF_ERR_InvalidInterfaceType,                     // The suggested network interface type is not supported

    ONVIF_ERR_StreamConflict,                           // Specification of StreamType or Transport part in causes conflict with other streams.
    ONVIF_ERR_IncompleteConfiguration,                  // The specified media profile does not have the minimum amount of configurations to have streams
    ONVIF_ERR_InvalidMulticastSettings,                 // No configuration is configured for multicast
    ONVIF_ERR_InvalidPolygon,                           // The provided polygon is not supported

    ONVIF_ERR_MaxAccessPoints,                          // There is not enough space to add new AccessPoint
    ONVIF_ERR_MaxAreas,                                 // There is not enough space to add new area
    ONVIF_ERR_TypeNotExistent,                          // The module option type does not exist

    ONVIF_ERR_TooManyEntries,                           // The requested geo location list exceeds the supported number of entries
    ONVIF_ERR_NoAutoGeo,                                // The device does not support automatic retrieval of geo information
    ONVIF_ERR_Fixed,                                    // Cannot delete a fixed entity

    ONVIF_ERR_MaximumNumberOfKeysReached,               // The keystore does not have enough storage space to store the key pair that has to be generated
    ONVIF_ERR_KeyLength,                                // The specified key length is not supported by the device
    ONVIF_ERR_UnsupportedEllipticCurve,                 // The specified elliptic curve is not supported by the device
    ONVIF_ERR_KeyID,                                    // No key is stored under the requested KeyID
    ONVIF_ERR_KeyDeletionFailed,                        // Deleting the key with the requested KeyID failed
    ONVIF_ERR_ReferenceExists,                          // A reference exists for the object that is to be deleted
    ONVIF_ERR_CSRCreationFailed,                        // The generation of the PKCS#10 certification request failed
    ONVIF_ERR_UnsupportedSignatureAlgorithm,            // The specified signature algorithm is not supported by the device
    ONVIF_ERR_KeySignatureAlgorithmMismatch,            // The specified public key is an invalid input to the specified signature algorithm
    ONVIF_ERR_InvalidKeyStatus,                         // The key with the requested KeyID has an inappropriate status
    ONVIF_ERR_InvalidSubject,                           // The specified subject is invalid or incomplete
    ONVIF_ERR_InvalidAttribute,                         // The specified attribute is invalid or incomplete
    ONVIF_ERR_PassphraseID,                             // No passphrase is stored under the requested PassphraseID
    ONVIF_ERR_DecryptionFailed,                         // The given date could not be decrypted
    ONVIF_ERR_UnsupportedPublicKeyAlgorithm,            // The public key algorithm of the supplied key pair is not supported by the device
    ONVIF_ERR_BadPKCS8File,                             // The PKCS#8 data structure cannot be processed by the device
    ONVIF_ERR_PublicPrivateKeyMismatch,                 // The supplied private key does not match the supplied public key
    ONVIF_ERR_InvalidKeyType,                           // The key stored in the keystore under the requested KeyID is of an invalid type
    ONVIF_ERR_MaximumNumberOfCertificatesReached,       // The device does not have enough storage space to store the certificate to be uploaded
    ONVIF_ERR_NoMatchingPrivateKey,                     // The keystore does not contain a key pair with a private key that matches the public key in the uploaded certificate.
    ONVIF_ERR_BadCertificate,                           // The supplied certificate file cannot be processed by the device
    ONVIF_ERR_Duplicate,                                // The certificate already exists
    ONVIF_ERR_MaximumNumberOfCertificationPathsReached, // The device does not have enough storage space to store the certification path to be uploaded
    ONVIF_ERR_BadPKCS12File,                            // The PKCS#12 data structure cannot be processed by the device
    ONVIF_ERR_InvalidCertificationPath,                 // At least one certificate in the certification path is not correctly signed with the public key in the next certificate in the path
    ONVIF_ERR_CertificateID,                            // No certificate is stored under the requested CertificateID
    ONVIF_ERR_CertificateDeletionFailed,                // Deleting the certificate with the requested CertificateID failed
    ONVIF_ERR_CertificationPathCreationFailed,          // Creating the certification path failed
    ONVIF_ERR_CertificationPathID,                      // No certification path is stored under the requested certification path ID
    ONVIF_ERR_CertificationPathDeletionFailed,          // Deleting the certification path with the requested certification path ID failed
    ONVIF_ERR_MaximumNumberOfCertPathValidationPoliciesReached, // The device does not have enough storage to store the certification path validation policy to be created
    ONVIF_ERR_CertPathValidationParameters,             // The specified certification path validation parameters are invalid
    ONVIF_ERR_CertPathValidationPolicyID,               // No certification path validation policy is stored under the requested certification path validation policy ID
    ONVIF_ERR_NoPrivateKey,                             // The key pair that is associated with the first certificate in the certificate chain does not have an associated private key
    ONVIF_ERR_MaximumNumberOfTLSCertificationPathsReached, // The maximum number of certification paths that may be assigned to the TLS server simultaneously is reached
    ONVIF_ERR_OldCertificationPathID,                   // No certification path under the given certification path ID is associated with the TLS server
    ONVIF_ERR_NewCertificationPathID,                   // No certification path is stored in the keystore under the given certification path ID
    ONVIF_ERR_EnablingClientAuthenticationFailed,       // The device does not support TLS client authentication, or TLS client authentication is not configured appropriately
    ONVIF_ERR_CnMapsToUserFailed,                       // The device does not support TLS client authentication
    ONVIF_ERR_MaximumNumberOfTLSCertPathValidationPoliciesReached, // The maximum number of certification path validation policies that may be assigned to the TLS server simultaneously is reached
    ONVIF_ERR_OldCertPathValidationPolicyID,            // No certification path validation policy under the given OldCertPathValidationPolicyID is associated with the TLS server
    ONVIF_ERR_NewCertPathValidationPolicyID,            // No certification path validation policy under the given NewCertPathValidationPolicyID is stored in the device's keystore
    ONVIF_ERR_MaximumNumberOfPassphrasesReached,        // The device does not have enough storage space to store the passphrase to be uploaded
    ONVIF_ERR_BadPassphrase,                            // The provided passphrase cannot be processed by the device
    ONVIF_ERR_PassphraseDeletionFailed,                 // Deleting the passphrase with the requested PassphraseID failed
    ONVIF_ERR_MaximumNumberOfCRLsReached,               // The device does not have enough storage space to store the CRL to be uploaded
    ONVIF_ERR_BadCRL,                                   // The supplied CRL cannot be processed by the device
    ONVIF_ERR_CRLID,                                    // No CRL is stored under the requested CRL ID
    ONVIF_ERR_EmptyList,                                // The version list is empty
    ONVIF_ERR_TLSVersion,                               // A version is not recognized
} ONVIF_RET;
...
typedef struct _VideoEncoder2ConfigurationList
{
    ...
    VideoEncoder2ConfigurationOptionsList * Options2;
...
typedef struct _AudioEncoder2ConfigurationList
{
    ...
    AudioEncoder2ConfigurationOptionsList * Options;
