...
#ifndef VIDIO_CAPTURE_MAC_H
#define VIDIO_CAPTURE_MAC_H
...
class CMVideoCapture : public CVideoCapture
{
public:
    ...
    void    captureThread();
    void    videoCallBack(avf_video_data * data);
    
private:
    CMVideoCapture();
    CMVideoCapture(CMVideoCapture &obj);
    ~CMVideoCapture();
