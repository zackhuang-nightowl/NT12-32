...
COMPILEOPTION += -DRTSP_OVER_WEBSOCKET
...
ifneq ($(findstring armv7a, $(PLATFORM)),)
LIBDIRS += -L./libsrt/lib/armeabi-v7a
LIBDIRS += -L./libsrtp/lib/armeabi-v7a
LIBDIRS += -L./ffmpeg/lib/armeabi-v7a
LIBDIRS += -L./openssl/lib/armeabi-v7a
endif
ifneq ($(findstring aarch64, $(PLATFORM)),)
LIBDIRS += -L./libsrt/lib/arm64-v8a
LIBDIRS += -L./libsrtp/lib/arm64-v8a
LIBDIRS += -L./ffmpeg/lib/arm64-v8a
