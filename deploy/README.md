...
/dvr/tutk_cloud_agent/                            TUTK ODC agent（device.sh + cgi + profile；AVAPIs_Server_CLI 另放）
...
chmod +x /dvr/tutk_cloud_agent/device.sh /dvr/tutk_cloud_agent/nvr_tutk_cgi /dvr/tutk_cloud_agent/AVAPIs_Server_CLI
